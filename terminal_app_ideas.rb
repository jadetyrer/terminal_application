...
# puts "colorize gem demo!"

# puts "Hello".colorize(:blue)
# puts "Hello again".colorize(:red)
    ...
    bright_yellow = Rainbow("Bright Yelloe").gold
    ...
    colour_choice = prompt.multi_select("Choose your colour:", chioces)



nail_shape = ["Square", "Oval", "Squoval", "Rounded", "Stiletto", "Almond", "Coffin"]

nail_art = ["None", "Stenciled", "Ombre", "Stickers", "Marbled", "Two-toned", "Polka-dot", "French", "Matt-look", "Aztec", "Glitter", "Jewelled", "Metallic"]
