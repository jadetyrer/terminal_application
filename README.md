...
5. Make the script executable by entering `chmod +x build.sh` to terminal
6. Type in `./build.sh` to the terminal to download the relevant gems and files
7. cd into the `dist` directory
8. Start the program by typing `bespoke_nail_booker.rb {'salon name'}` 
